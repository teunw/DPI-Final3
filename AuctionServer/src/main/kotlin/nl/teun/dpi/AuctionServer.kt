...
import nl.teun.dpi.communication.KBusRequestReply
import nl.teun.dpi.data.Auction
import nl.teun.dpi.data.User
import nl.teun.dpi.data.replies.StringReply
...
import nl.teun.dpi.data.requests.StringRequest
...
//            }
    ...
    KBusRequestReply().setupReplier<StringRequest, StringReply> {
        StringReply("${it.str} from the server")
    }

    KBusRequestReply().requestMessage<StringRequest, StringReply>(StringRequest("Hello world"), {
        println(it.str)
    })
